//! Generated tables: the Adobe Glyph List and the base encodings.
//!
//! DO NOT EDIT. Regenerate with:
//!
//! ```text
//! python crates/rasura-layout/generate-tables.py glyphlist.txt \
//!     > crates/rasura-layout/src/glyphdata.rs
//! ```
//!
//! The glyph list is Adobe's, from
//! <https://github.com/adobe-type-tools/agl-aglfn>, BSD-3-Clause. Its licence
//! is vendored at crates/rasura-layout/AGL-LICENSE.
//!
//! Q1 established that this table carries the load in spec 7.2: 300 of the
//! 653 fonts in the corpus without a usable /ToUnicode resolve through it and
//! nothing else. It has to be the whole list, not a table of common names.

/// The Adobe Glyph List: 4281 entries, sorted by name so
/// [`crate::agl::lookup`] can binary-search it.
pub static AGL: [(&str, &str); 4281] = [
    ("A", "A"),
    ("AE", "\u{c6}"),
    ("AEacute", "\u{1fc}"),
    ("AEmacron", "\u{1e2}"),
...
/// Glyph names of Adobe StandardEncoding, for metric lookup.
pub static STANDARD_NAMES: [Option<&str>; 256] = [
    None,
    None,
    None,
    None,
...
/// Glyph names of WinAnsiEncoding, for metric lookup.
pub static WIN_ANSI_NAMES: [Option<&str>; 256] = [
    None,
    None,
    None,
    None,
...
/// Glyph names of MacRomanEncoding, for metric lookup.
pub static MAC_ROMAN_NAMES: [Option<&str>; 256] = [
    None,
    None,
    None,
    None,
...
/// Glyph names of the Symbol font's built-in encoding.
pub static SYMBOL_NAMES: [Option<&str>; 256] = [
    None,
    None,
    None,
    None,
...
pub static ZAPF_DINGBATS_NAMES: [Option<&str>; 256] = [
    None,
    None,
    None,
    None,
...
pub static SYMBOL_ENCODING: [Option<&str>; 256] = [
    None,
    None,
    None,
    None,
...
pub static ZAPF_DINGBATS_ENCODING: [Option<&str>; 256] = [
    None,
    None,
    None,
    None,
